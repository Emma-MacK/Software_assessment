...
import requests
import sys
sys.path.insert(0, "/home/raymondmiles/Software_assessment/src/") # insert the path to the folder
...
def tool(testID, PanelSource):
    ...
    if PanelSource == "NGTD":
        ...
        xls = '/home/raymondmiles/Software_assessment/Rare-and-inherited-disease-national-genomic-test-directory-version-5.1.xlsx'
